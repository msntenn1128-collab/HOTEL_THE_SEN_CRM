...
COLUMN_ALIASES = {
    ...
    "membership_amount": ["会員権金額(千円)", "会員権金額"],
    "contract_document_confirm": ["契約書確認", "契約書"],
    "deposit_amount": ["予約金(千円)", "予約金"],
    "deposit_payment_confirm": ["予約金入金確認"],
    "annual_fee": ["年会費(千円)", "年会費"],
    "sales_2026_08_09": ["2026年8-9月売上計上(30%)", "2026年8-9月"],
    "sales_2027_06": ["2027年6月売上計上(30%)", "2027年6月"],
    "completion_2029_04": ["2029年4月竣工時(40%)", "2029年4月"],
    "contract_total": ["計"],
    "invoice_issued": ["請求書発行済", "請求書発行済み"],
    "payment_contact_memo": ["入金連絡メモ"],
    "event_participation_count": ["累計イベント参加回数"],
    "ari_investment_amount": ["累計ARI投資額(千円)", "累計ARI投資額"],
    "contact_alert_3_months": ["接点アラート(三か月)", "接点アラート"],
    "next_follow": ["次フォロー"],
...
CONTRACT_DETAIL_SECTIONS = [
    ("基本情報", [("NO", "no"), ("ステージ", "stage"), ("担当者", "owner"), ("氏名", "name"), ("会社名", "company"), ("会社HP", "company_hp")]),
    (
        "契約情報",
        [("ティア", "tier"), ("会員権金額(千円)", "membership_amount"), ("契約書確認", "contract_document_confirm")],
    ),
    (
        "支払い管理",
        [
            ("予約金(千円)", "deposit_amount"),
            ("予約金入金確認", "deposit_payment_confirm"),
            ("年会費(千円)", "annual_fee"),
            ("2026年8-9月(30%)", "sales_2026_08_09"),
            ("2027年6月(30%)", "sales_2027_06"),
            ("2029年4月(40%)", "completion_2029_04"),
        ],
    ),
    (
        "集計・書類",
    ...
    (
        ...
        [
            ...
            ("最終接触日", "last_contact"),
            ("接点アラート(三か月)", "contact_alert_3_months"),
            ("次フォロー", "next_follow"),
        ],
    ),
]
